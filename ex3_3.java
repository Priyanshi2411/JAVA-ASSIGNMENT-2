//21CE141 : PRIYANSHI TALAVIYA PRAC3 : MAIN
import java.util.*;
public class ex3_3 {
	public static void main(String[] args) {
        ...
        int choice;
        double amt;
        //create arraylist for 10 ID
        ArrayList<ex3> people = new ArrayList<ex3>();
        for (int i = 1; i <= 10; i++) {
            people.add(new ex3());
        }
    ...
    public static int userID(String id, ArrayList<ex3>people) {
