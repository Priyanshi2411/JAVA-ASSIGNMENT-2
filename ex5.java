//21CE141 : PRIYANSHI TALAVIYA PRAC5 : CLASS
public class ex5 {
	//method for show student information
...
public static void information(String name ,String degree, String faculty_of,int experience,
								long salary)
    {
