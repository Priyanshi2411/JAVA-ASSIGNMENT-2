//21CE141 : PRIYANSHI TALAVIYA PRAC5 : MAIN
import java.util.*;
public class pr5_5 {
	public static void main(String[] args) {
        ...
        ex5.information(roll_no_std, name_std, branch_std);
        System.out.println("------------------------------------------------------------------");
        
        //method information call for show data of faculty member
        System.out.println("The given information of professor is  :");
        ex5.information(name_pro, degree_pro, faculty_of_pro, experience, salary);
    }
}
